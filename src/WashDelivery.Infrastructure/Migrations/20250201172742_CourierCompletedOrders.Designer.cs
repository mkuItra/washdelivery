...
namespace WashDelivery.Infrastructure.Migrations
{
    ...
    [Migration("20250201172742_CourierCompletedOrders")]
    partial class CourierCompletedOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WashDelivery.Domain.Entities.CourierCompletedOrder", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CourierCompletedOrders");
                });
            ...
            modelBuilder.Entity("WashDelivery.Domain.Entities.LaundryOrderView", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("OrderId", "LaundryId")
                        .IsUnique();

                    b.ToTable("LaundryOrderViews");
                });
            ...
            modelBuilder.Entity("WashDelivery.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("AcceptedByLaundryAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WashDelivery.Domain.Entities.RejectedOrder", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WashDelivery.Domain.Entities.CourierCompletedOrder", b =>
                {
                    b.HasOne("WashDelivery.Domain.Entities.User", "Courier")
                        .WithMany()
